...
import { IDeliveryFeePolicyItem, IFilterBase, IGetSellerRequestingProfileListPayload } from '@shared/models';
...
@Component({
  selector: 'app-delivery-fee-policy-list',
  templateUrl: './delivery-fee-policy-list.component.html',
  styleUrl: './delivery-fee-policy-list.component.scss',
})
export class DeliveryFeePolicyListComponent implements OnInit, OnDestroy {
