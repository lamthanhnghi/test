...
import { IPrivacyPolicy } from '@shared/privacy-policy.model';

@Component({
  selector: 'app-privacy-policy-list',
  templateUrl: './privacy-policy-list.component.html',
  styleUrl: './privacy-policy-list.component.scss',
})
        ...
        next: (res) => {
          if (res.statusCode == 200) {
            this.menuItems = this.menuItems.map((parent) => {
              if (parent.id != 'privacy-policies') return parent;
