...
import { ISalesFeePolicyItem } from '@shared/sales-fee-policy.model';

@Component({
  selector: 'app-sales-fee-policy-list',
  templateUrl: './sales-fee-policy-list.component.html',
  styleUrl: './sales-fee-policy-list.component.scss',
})
export class SalesFeePolicyListComponent implements OnInit, OnDestroy {
