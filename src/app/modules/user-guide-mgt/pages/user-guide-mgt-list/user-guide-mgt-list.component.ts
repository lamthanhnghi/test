...
import { CONTACT_AND_SUPPORT_MENU_ITEMS } from '@shared/constants/side-menu.constant';
import { RouteUtils } from '@shared/utils';
import { eContentStatuses, eUserTypes } from '@shared/enums';
import { IFilterBase, IMcBreadcrumb } from '@shared/models';
...
import { IGetUserGuideListPayload, IUserGuide } from '@shared/user-guide.model';

@Component({
  selector: 'app-user-guide-mgt-list',
  templateUrl: './user-guide-mgt-list.component.html',
  styleUrl: './user-guide-mgt-list.component.scss',
})
export class UserGuideMgtListComponent implements OnInit, OnDestroy {
  menuItems = CONTACT_AND_SUPPORT_MENU_ITEMS;
  breadcrumbs: IMcBreadcrumb[] = [
    { title: 'common.contact-and-support', link: ['/'] },
    { title: 'menu.guide', link: '/', disabled: true },
  ];
  selectedIndex: 0 | 1 = 0;
  typeIndexMap = {
    [0]: eUserTypes.Seller,
